...
export default function HoverLink({ href, text }) {
	...
	return (
		<View className="group relative">
			<Link
				className="bg-white relative z-10 inline-flex h-12 items-center justify-center overflow-hidden rounded-md border border-neutral-200 bg-transparent px-6 font-medium text-neutral-600 transition-all duration-300 group-hover:-translate-x-3 group-hover:-translate-y-3 group-active:translate-x-0 group-active:translate-y-0"
				href={href}
			>
				<Text>{text}</Text>
			</Link>
